...
# Load data
data1 = pd.read_csv('./backend/test/data/data1.csv', encoding='utf-8')
data2 = pd.read_csv('./backend/test/data/data2.csv', encoding='utf-8')
data3 = pd.read_csv('./backend/test/data/data3.csv', encoding='utf-8')
data4 = pd.read_csv('./backend/test/data/data4.csv', encoding='utf-8')
data5 = pd.read_csv('./backend/test/data/data5.csv', encoding='utf-8')
data6 = pd.read_csv('./backend/test/data/data6.csv', encoding='utf-8')
data7 = pd.read_csv('./backend/test/data/data7.csv', encoding='utf-8')
data8 = pd.read_csv('./backend/test/data/data8.csv', encoding='utf-8')
data9 = pd.read_csv('./backend/test/data/data9.csv', encoding='utf-8')
    ...
    def predict(self,idQuestion, text):
        ...
        if idQuestion == 1:
            ...
            if utils.verifyQuestion1(df['جواب'][0]):
                ...
                loaded_model = pickle.load(open('./backend/test/model1.sav', 'rb'))
            ...
            if utils.verifyQuestion2(df['جواب'][0]):
                vectorize_answer = np.array([vectorize_text(idQuestion,text) for text in df['جواب']])
                loaded_model = pickle.load(open('./backend/test/model2.sav', 'rb'))
                Class=loaded_model.predict(vectorize_answer)
                return Class
        elif idQuestion == 3:
            if utils.verifyQuestion3(df['جواب'][0]):
                vectorize_answer = np.array([vectorize_text(idQuestion,text) for text in df['جواب']])
                loaded_model = pickle.load(open('./backend/test/model3.sav', 'rb'))
                Class=loaded_model.predict(vectorize_answer)
                return Class
        elif idQuestion == 4:
            if utils.verifyQuestion4(df['جواب'][0]):
                vectorize_answer = np.array([vectorize_text(idQuestion,text) for text in df['جواب']])
                loaded_model = pickle.load(open('./backend/test/model4.sav', 'rb'))
                Class=loaded_model.predict(vectorize_answer)
                return Class
        elif idQuestion == 5:
            if utils.verifyQuestion5(df['جواب'][0]):
                vectorize_answer = np.array([vectorize_text(idQuestion,text) for text in df['جواب']])
                loaded_model = pickle.load(open('./backend/test/model5.sav', 'rb'))
                Class=loaded_model.predict(vectorize_answer)
                return Class
        elif idQuestion == 6:
            if utils.verifyQuestion6(df['جواب'][0]):
                vectorize_answer = np.array([vectorize_text(idQuestion,text) for text in df['جواب']])
                loaded_model = pickle.load(open('./backend/test/model6.sav', 'rb'))
                Class=loaded_model.predict(vectorize_answer)
                return Class
        elif idQuestion == 7:
            if utils.verifyQuestion7(df['جواب'][0]):
                vectorize_answer = np.array([vectorize_text(idQuestion,text) for text in df['جواب']])
                loaded_model = pickle.load(open('./backend/test/model7.sav', 'rb'))
                Class=loaded_model.predict(vectorize_answer)
                return Class
            ...
            if utils.verifyQuestion8(df['جواب'][0]):
                vectorize_answer = np.array([vectorize_text(idQuestion,text) for text in df['جواب']])
                loaded_model = pickle.load(open('./backend/test/model8.sav', 'rb'))
                Class=loaded_model.predict(vectorize_answer)
                return Class
        elif idQuestion == 9:
            if utils.verifyQuestion9(df['جواب'][0]):
                vectorize_answer = np.array([vectorize_text(idQuestion,text) for text in df['جواب']])
                loaded_model = pickle.load(open('./backend/test/model9.sav', 'rb'))
                Class=loaded_model.predict(vectorize_answer)
                return Class
        return 0
